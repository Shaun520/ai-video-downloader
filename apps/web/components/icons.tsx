/** 极简 SVG 图标集（手写 Heroicons 风格，避免 emoji 当图标） */
...
export function TreeIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M6.5 8v3M17.5 8v3M16 14v2a1 1 0 0 1-1 1h-5" />
    </svg>
  );
}
...
export function CaptionsIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M7 15h4M7 12h4M13 12h4M13 15h2" />
    </svg>
  );
}
...
export function LogoutIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M9 5V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H10a1 1 0 0 1-1-1v-1" />
    </svg>
  );
}
...
export function SpinnerIcon(props: IconProps) {
  return (
    <svg {...base} {...props} className={`animate-spin ${props.className ?? ""}`}>
      <circle className="opacity-25" cx="12" cy="12" r="9" strokeWidth="3" />
      <path className="opacity-80" d="M12 3a9 9 0 0 1 9 9" strokeWidth="3" />
    </svg>
  );
}
